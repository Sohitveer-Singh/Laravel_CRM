...
<main class=" w-xs lg:w-lg bg-blue-100 p-5 rounded-md">
    <form action="{{route('register.store')}}" method="POST">
        @csrf
        <div class="flex flex-col mb-4">
            <label for="email">Email</label>
            <input class="border rounded-md p-2" name="email" type="email" placeholder="Enter Your Email ">
            @error('email')
            <span class="mt-3 py-1 px-2  border border-red-400 rounded-md" >{{$message}} </span>
            @enderror
        </div>
        <div class="flex flex-col mb-4">
            <label for="name">Name</label>
            <input class="border rounded-md p-2" name="name" type="text" placeholder="Enter Your Name ">
            @error('name')
            <span class="mt-3 py-1 px-2  border border-red-400 rounded-md" >{{$message}} </span>
            @enderror
        </div>
        <div class="flex flex-col mb-4">
            ...
            <input class="border rounded-md p-2" name="password" type="password" placeholder="Enter Your Password ">
            @error('password')
            <span class="mt-3 py-1 px-2  border border-red-400 rounded-md" >{{$message}} </span>
            @enderror
        </div>
        <div class="flex flex-col mb-4">
            ...
            <input class="border rounded-md p-2" name="password_confirmation" type="password" placeholder="Enter Your Password ">

        </div>
        <button class="p-2 border rounded-md px-4">
            Register
        </button>
    </form>
</main>
{{--<div class="absolute top-1 right-1 w-36 h-12 bg-red-400">--}}
{{--    --}}
{{--</div>--}}
</body>
</html>
